...
- It's important to choose a specific Black version and be consistent with it.
  ...
  "formatted" in one version may not be in another. As of 2022 Black has a [stability policy](https://black.readthedocs.io/en/stable/the_black_code_style/index.html) which states the formatting won't change in a calendar year.
