...
I've often wondered if "people only vote for what they play on the radio". So I
set about finding out if that was true. It'll give me a chance to try Python's
pandas library.
