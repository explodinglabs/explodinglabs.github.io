...
The tools I use are Black.(code formatter), Pylint (linter) and Mypy (type checker).  A fourth is Pytest, but this can take some time to run so I run it manually
